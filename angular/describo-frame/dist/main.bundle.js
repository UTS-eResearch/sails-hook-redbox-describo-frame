...
var DashboardService = /** @class */ (function (_super) {
    ...
    DashboardService.prototype.getAllDraftPlansCanEdit = function () {
        ...
        var start = 0;
        return this.http.get(this.brandingAndPortalUrl + "/listRecords?recordType=rdmp&state=draft&editOnly=true&start=" + start + "&rows=" + rows + "&ts=" + __WEBPACK_IMPORTED_MODULE_4_moment__().unix(), this.options)
            .toPromise()
    ...
    DashboardService.prototype.getAllRecordsCanEdit = function (recordType, state) {
        ...
        var rows = this.config.maxTransferRowsPerPage;
        var start = 0;
        var url = this.brandingAndPortalUrl + "/listRecords?recordType=" + recordType + "&editOnly=true&start=" + start + "&rows=" + rows + "&ts=" + __WEBPACK_IMPORTED_MODULE_4_moment__().unix();
        if (state != '') {
            url += "&state=" + state;
        }
    ...
    DashboardService.prototype.getActivePlans = function (pageNumber) {
        ...
        return this.http.get(this.brandingAndPortalUrl + "/listRecords?state=active&start=" + start + "&rows=" + rows + "&ts=" + __WEBPACK_IMPORTED_MODULE_4_moment__().unix(), this.options)
            .toPromise()
            .then(function (res) { return _this.formatDates(_this.extractData(res)); });
    };
    DashboardService.prototype.getDraftPlans = function (pageNumber) {
        ...
        var rows = 10;
        var start = (pageNumber - 1) * rows;
        return this.http.get(this.brandingAndPortalUrl + "/listRecords?recordType=rdmp&state=draft&start=" + start + "&rows=" + rows + "&ts=" + __WEBPACK_IMPORTED_MODULE_4_moment__().unix(), this.options)
            .toPromise()
            .then(function (res) { return _this.formatDates(_this.extractData(res)); });
    };
    DashboardService.prototype.getRecords = function (recordType, state, pageNumber, packageType, sort) {
        ...
        return this.http.get(this.brandingAndPortalUrl + "/listRecords?" + recordType + packageType + state + sort + "&start=" + start + "&rows=" + rows + "&ts=" + __WEBPACK_IMPORTED_MODULE_4_moment__().unix(), this.options)
            .toPromise()
            .then(function (res) { return _this.formatDates(_this.extractData(res)); });
    };
    DashboardService.prototype.formatDates = function (response) {
        ...
        for (var i = 0; i < items.length; i++) {
            items[i]["dateCreated"] = __WEBPACK_IMPORTED_MODULE_4_moment__(items[i]["dateCreated"]).local().format('LLL');
            items[i]["dateModified"] = __WEBPACK_IMPORTED_MODULE_4_moment__(items[i]["dateModified"]).local().format('LLL');
        }
        return response;
    };
    ...
    DashboardService.prototype.searchRecords = function (pageNumber, basicSearch, facets) {
        ...
        var start = (pageNumber - 1) * rows;
        return this.http.get(this.brandingAndPortalUrl + "/searchPlans?start=" + start + "&rows=" + rows + "&query=" + basicSearch + "&facets=" + facets + "&ts=" + __WEBPACK_IMPORTED_MODULE_4_moment__().unix(), this.options)
            .toPromise()
            .then(function (res) { return _this.formatDates(_this.extractData(res)); });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__form_field_recordpermissions_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-recordpermissions.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__form_field_relatedobjectselector_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-relatedobjectselector.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__form_field_relatedfileupload_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-relatedfileupload.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__form_field_publishdatalocationselector_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-publishdatalocationselector.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__form_field_map_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-map.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__form_field_group_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-group.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__form_workspace_field_component__ = __webpack_require__("./redbox-portal/angular/shared/form/workspace-field.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__form_workspace_selector_component__ = __webpack_require__("./redbox-portal/angular/shared/form/workspace-selector.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__form_field_andsvocab_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-andsvocab.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__form_field_pdflist_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-pdflist.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__form_field_asynch_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-asynch.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__form_field_publish_data_location_refresh_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-publish-data-location-refresh.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__form_html_event_component__ = __webpack_require__("./redbox-portal/angular/shared/form/html-event.component.ts");
...
var fieldClasses = {
    ...
    'Container': { 'meta': __WEBPACK_IMPORTED_MODULE_0__form_field_simple__["d" /* Container */], 'comp': [__WEBPACK_IMPORTED_MODULE_2__form_field_simple_component__["p" /* TextBlockComponent */], __WEBPACK_IMPORTED_MODULE_16__form_field_group_component__["a" /* GenericGroupComponent */]] },
    ...
    'RecordPermissionsField': { 'meta': __WEBPACK_IMPORTED_MODULE_10__form_field_recordpermissions_component__["b" /* RecordPermissionsField */], 'comp': __WEBPACK_IMPORTED_MODULE_10__form_field_recordpermissions_component__["a" /* RecordPermissionsComponent */], 'lookupService': 'vocabFieldLookupService' },
    'MapField': { 'meta': __WEBPACK_IMPORTED_MODULE_15__form_field_map_component__["b" /* MapField */], 'comp': __WEBPACK_IMPORTED_MODULE_15__form_field_map_component__["a" /* MapComponent */], 'lookupService': 'vocabFieldLookupService' },
    ...
    'RelatedObjectSelector': { 'meta': __WEBPACK_IMPORTED_MODULE_12__form_field_relatedobjectselector_component__["b" /* RelatedObjectSelectorField */], 'comp': __WEBPACK_IMPORTED_MODULE_12__form_field_relatedobjectselector_component__["a" /* RelatedObjectSelectorComponent */] },
    'RelatedFileUpload': { 'meta': __WEBPACK_IMPORTED_MODULE_13__form_field_relatedfileupload_component__["b" /* RelatedFileUploadField */], 'comp': __WEBPACK_IMPORTED_MODULE_13__form_field_relatedfileupload_component__["a" /* RelatedFileUploadComponent */] },
    ...
    'WorkspaceSelectorField': { 'meta': __WEBPACK_IMPORTED_MODULE_17__form_workspace_field_component__["b" /* WorkspaceSelectorField */], 'comp': [__WEBPACK_IMPORTED_MODULE_18__form_workspace_selector_component__["a" /* WorkspaceSelectorComponent */], __WEBPACK_IMPORTED_MODULE_18__form_workspace_selector_component__["b" /* WorkspaceSelectorFieldComponent */]] },
    'PublishDataLocationSelector': { 'meta': __WEBPACK_IMPORTED_MODULE_14__form_field_publishdatalocationselector_component__["b" /* PublishDataLocationSelectorField */], 'comp': __WEBPACK_IMPORTED_MODULE_14__form_field_publishdatalocationselector_component__["a" /* PublishDataLocationSelectorComponent */] },
    ...
    'ANDSVocab': { 'meta': __WEBPACK_IMPORTED_MODULE_19__form_field_andsvocab_component__["b" /* ANDSVocabField */], 'comp': __WEBPACK_IMPORTED_MODULE_19__form_field_andsvocab_component__["a" /* ANDSVocabComponent */] },
    'PDFList': { 'meta': __WEBPACK_IMPORTED_MODULE_20__form_field_pdflist_component__["b" /* PDFListField */], 'comp': __WEBPACK_IMPORTED_MODULE_20__form_field_pdflist_component__["a" /* PDFListComponent */] },
    'AsynchField': { 'meta': __WEBPACK_IMPORTED_MODULE_21__form_field_asynch_component__["b" /* AsynchField */], 'comp': __WEBPACK_IMPORTED_MODULE_21__form_field_asynch_component__["a" /* AsynchComponent */] },
    ...
    'PublishDataLocationRefresh': { 'meta': __WEBPACK_IMPORTED_MODULE_22__form_field_publish_data_location_refresh_component__["b" /* PublishDataLocationRefreshField */], 'comp': __WEBPACK_IMPORTED_MODULE_22__form_field_publish_data_location_refresh_component__["a" /* PublishDataLocationRefreshComponent */] },
    'EventHandler': { 'meta': __WEBPACK_IMPORTED_MODULE_23__form_html_event_component__["a" /* EventHandler */], 'comp': __WEBPACK_IMPORTED_MODULE_23__form_html_event_component__["b" /* EventHandlerComponent */] }
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__field_simple_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-simple.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__field_base__ = __webpack_require__("./redbox-portal/angular/shared/form/field-base.ts");
...
var ActionButton = /** @class */ (function (_super) {
    ...
    function ActionButton(options, injector) {
        ...
        _this.recordService = _this.getFromInjector(__WEBPACK_IMPORTED_MODULE_4__records_service__["a" /* RecordsService */]);
        _this.value = options['value'] || null;
        // read from the form config if this action button should be part of the form (i.e. hold values)
        _this.hasControl = __WEBPACK_IMPORTED_MODULE_0_lodash__["isUndefined"](options['hasControl']) ? _this.hasControl : options['hasControl'];
        // controls if the action button will be disabled
        _this.isDisabledTemplate = options['isDisabledTemplate'];
        _this.valueLabelPrefix = __WEBPACK_IMPORTED_MODULE_0_lodash__["isUndefined"](options['valueLabelPrefix']) ? _this.getTranslated(options['valueLabelPrefix'], '') : '';
        _this.valueLabelSufffix = __WEBPACK_IMPORTED_MODULE_0_lodash__["isUndefined"](options['valueLabelSufffix']) ? _this.getTranslated(options['valueLabelSufffix'], '') : '';
        _this.submittingLabel = __WEBPACK_IMPORTED_MODULE_0_lodash__["isUndefined"](options['submittingLabel']) ? _this.getTranslated(options['submittingLabel'], '') : '';
        _this.unsubmittedLabel = __WEBPACK_IMPORTED_MODULE_0_lodash__["isUndefined"](options['unsubmittedLabel']) ? _this.getTranslated(options['unsubmittedLabel'], '') : '';
        _this.valueIsUrl = __WEBPACK_IMPORTED_MODULE_0_lodash__["isUndefined"](options['valueIsUrl']) ? true : options['valueIsUrl'];
        _this.isDisabledTemplate = options['isDisabledTemplate'];
        _this.isRecordAction = __WEBPACK_IMPORTED_MODULE_0_lodash__["isUndefined"](options['isRecordAction']) ? false : options['isRecordAction'];
        return _this;
    }
    ...
    return ActionButton;
}(__WEBPACK_IMPORTED_MODULE_3__field_base__["a" /* FieldBase */]));
...
var ActionButtonComponent = /** @class */ (function (_super) {
    ...
    ActionButtonComponent.prototype.isDisabled = function () {
        if (__WEBPACK_IMPORTED_MODULE_0_lodash__["isEmpty"](this.field.isDisabledTemplate)) {
            return false;
        }
        var imports = __WEBPACK_IMPORTED_MODULE_0_lodash__["extend"]({}, this);
        var templateData = { imports: imports };
        var template = __WEBPACK_IMPORTED_MODULE_0_lodash__["template"](this.field.isDisabledTemplate, templateData);
...
}(__WEBPACK_IMPORTED_MODULE_2__field_simple_component__["l" /* SimpleComponent */]));
...
var DmpFieldComponent = /** @class */ (function () {
    ...
    DmpFieldComponent.prototype.isDisabled = function () {
        ...
        if (disabledExpression != null) {
            ...
            variables.imports['moment'] = __WEBPACK_IMPORTED_MODULE_4_moment__;
...
var AsynchComponent = /** @class */ (function (_super) {
    ...
    AsynchComponent.prototype.formatDateForDisplay = function (value) {
        return value ? __WEBPACK_IMPORTED_MODULE_7_moment__(value).locale(this.locale).format(this.field.dateFormat) : '';
    };
...
var FieldBase = /** @class */ (function () {
            ...
            __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](subscribeConfig, function (subConfig, srcName) {
                __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](subConfig, function (eventConfArr, eventName) {
                    ...
                    eventEmitter.subscribe(function (value) {
                        ...
                        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](value) && !dataAsArray) {
                            curValue = [];
                            __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](value, function (v) {
                                var entryVal = v;
                                __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](eventConfArr, function (eventConf) {
    ...
    FieldBase.prototype.execVisibilityFn = function (data, visibilityCriteria) {
        var newVisible = this.visible;
        var fn = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this, __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](visibilityCriteria, 'action'));
        if (fn) {
            var boundFunction = fn;
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["get"](visibilityCriteria, 'action', '').indexOf(".") == -1) {
                boundFunction = fn.bind(this);
            }
            else {
                var objectName = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](visibilityCriteria, 'action', '').substring(0, __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](visibilityCriteria, 'action', '').indexOf("."));
                boundFunction = fn.bind(this[objectName]);
            }
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["get"](visibilityCriteria, 'passCriteria') == true) {
    ...
    FieldBase.prototype.setVisibility = function (data, eventConf) {
        var _this = this;
        if (eventConf === void 0) { eventConf = {}; }
        var newVisible = this.visible;
        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](this.visibilityCriteria)) {
            // save the value of this data in a map, so we can run complex conditional logic that depends on one or more fields
            if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](eventConf) && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](eventConf.srcName)) {
                this.subscriptionData[eventConf.srcName] = data;
            }
            // only run the function set if we have all the data...
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["size"](this.subscriptionData) == __WEBPACK_IMPORTED_MODULE_4_lodash__["size"](this.visibilityCriteria)) {
                newVisible = true;
                __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](this.visibilityCriteria, function (visibilityCriteria) {
                    var dataEntry = _this.subscriptionData[visibilityCriteria.fieldName];
                    newVisible = newVisible && _this.execVisibilityFn(dataEntry, visibilityCriteria);
                });
            }
        }
        else if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isObject"](this.visibilityCriteria) && __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this.visibilityCriteria, 'type') == 'function') {
            newVisible = this.execVisibilityFn(data, this.visibilityCriteria);
        }
        else {
            newVisible = __WEBPACK_IMPORTED_MODULE_4_lodash__["isEqual"](data, this.visibilityCriteria);
        }
        var that = this;
        setTimeout(function () {
            if (!newVisible) {
     ...
     * @return
     */
    FieldBase.prototype.setAnotherProperty = function (curValue, config) {
        var propValue = curValue;
        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](config.template)) {
            propValue = this.utilityService.runTemplate({ value: propValue, field: this }, config);
        }
        __WEBPACK_IMPORTED_MODULE_4_lodash__["set"](this, config.propertyPath, propValue);
...
var ContributorField = /** @class */ (function (_super) {
    ...
    function ContributorField(options, injector) {
        ...
        _this.forceLookup_clearOnTabThrough = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options['forceLookup_clearOnTabThrough']) ? true : options['forceLookup_clearOnTabThrough'];
        ...
        var showFieldRoleValue = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](_this.value, 'text_full_name') || __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](_this.value, 'email');
    ...
    ContributorField.prototype.createFormModel = function (valueElem) {
        ...
        if (!this.freeText) {
            ...
            this.formModel.addControl('honorific', new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["b" /* FormControl */](this.value.honorific));
            if (this.value) {
            ...
            this.formModel = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["c" /* FormGroup */]({ text_full_name: new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["b" /* FormControl */](this.value.text_full_name || null),
                ...
                honorific: new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["b" /* FormControl */](this.value.honorific || '')
            });
            if (this.splitNames) {
        ...
        if (value) {
            ...
            if (this.findRelationship && __WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.vocabField.initialValue.title)) {
                if (this.findRelationshipFor && this.relationshipFor) {
                    var doInit = __WEBPACK_IMPORTED_MODULE_4_lodash__["find"](this.findRelationshipFor, function (r) { return r === _this.relationshipFor; });
                    if (doInit) {
...
var ContributorComponent = /** @class */ (function (_super) {
    ...
    ContributorComponent.prototype.ngAfterViewInit = function () {
        ...
        if (this.field.editMode && this.ngCompleter) {
            ...
            this.ngCompleter.registerOnChange(function (v) {
                if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](v) && !that_1.field.forceLookup_clearOnTabThrough) {
    ...
    ContributorComponent.prototype.getGroupClass = function (fldName, wideMode) {
        ...
        return "col-xs-" + (wideMode ? '3' : '2') + " form-group" + additionalClass + (hasError ? ' has-error' : '') + " " + (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.field.cssClasses) || __WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.field.cssClasses[fldName]) ? '' : this.field.cssClasses[fldName]);
    };
...
var DataLocationField = /** @class */ (function (_super) {
    ...
    function DataLocationField(options, injector) {
        ...
        _this.allowUploadWithoutSave = __WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](options['allowUploadWithoutSave']) ? false : options['allowUploadWithoutSave'];
        return _this;
    }
...
var DataLocationComponent = /** @class */ (function (_super) {
    ...
    DataLocationComponent.prototype.initUppy = function (oid) {
        var _this = this;
        if (__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](oid) && this.field.allowUploadWithoutSave) {
            oid = "pending-oid";
        }
    ...
    DataLocationComponent.prototype.isAttachmentsDisabled = function () {
        if (__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](this.oid) && !this.field.allowUploadWithoutSave) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_numeral__ = __webpack_require__("./node_modules/numeral/numeral.js");
...
var PDFListField = /** @class */ (function (_super) {
    ...
    function PDFListField(options, injector) {
        ...
        _this.showVersionColumn = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options['showVersionColumn']) ? _this.showVersionColumn : options['showVersionColumn'];
        _this.useVersionLabelForFileName = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options['useVersionLabelForFileName']) ? _this.showVersionColumn : options['useVersionLabelForFileName'];
        ...
        _this.downloadBtnLabel = __WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](options['downloadBtnLabel']) ? "Download a PDF of this plan" : _this.getTranslated(options['downloadBtnLabel'], "Download a PDF of this plan");
        _this.downloadPreviousBtnLabel = __WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](options['downloadPreviousBtnLabel']) ? "Download a previous version" : _this.getTranslated(options['downloadPreviousBtnLabel'], "Download a previous version");
        _this.downloadPrefix = __WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](options['downloadPrefix']) ? "rdmp" : _this.getTranslated(options["downloadPrefix"], "rdmp");
        _this.fileNameTemplate = options['fileNameTemplate'];
        return _this;
    }
    PDFListField.prototype.getVersionLabel = function (attachment, index) {
        ...
        var version = null;
        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](versionValue)) {
            version = versionValue[versionValue.length - (index + 1)];
        }
        else {
            version = __WEBPACK_IMPORTED_MODULE_4_lodash__["toNumber"](versionValue) - index;
        }
    ...
    PDFListField.prototype.getDownloadUrl = function (url, attachment, index) {
        var fileName = this.downloadPrefix + ".pdf";
        var versionLabel = '';
        if (this.useVersionLabelForFileName) {
            versionLabel = this.getVersionLabel(attachment, index);
        }
        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.fileNameTemplate)) {
            if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](versionLabel)) {
                fileName = this.downloadPrefix + "-" + versionLabel + ".pdf";
            }
        }
        else {
            var imports = __WEBPACK_IMPORTED_MODULE_4_lodash__["extend"]({ versionLabel: versionLabel, moment: __WEBPACK_IMPORTED_MODULE_6_moment__, numeral: __WEBPACK_IMPORTED_MODULE_7_numeral__ }, this);
            var templateData = { imports: imports };
            var template = __WEBPACK_IMPORTED_MODULE_4_lodash__["template"](this.fileNameTemplate, templateData);
            fileName = template();
        }
...
var PDFListComponent = /** @class */ (function (_super) {
            ...
            allAttachmentsPromise.then(function (allAttachments) {
                ...
                __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](allAttachments, function (attachment) {
                    if (matchingExpression_1.test(attachment.label)) {
                        attachment.dateUpdated = __WEBPACK_IMPORTED_MODULE_6_moment__(attachment.dateUpdated).format('LLL');
                        that.field.pdfAttachments.push(attachment);
                        if (that.field.latestPdf == null || __WEBPACK_IMPORTED_MODULE_6_moment__(that.field.latestPdf['dateUpdated']).isBefore(__WEBPACK_IMPORTED_MODULE_6_moment__(attachment.dateUpdated))) {
                            that.field.latestPdf = attachment;
                        }
                    }
                });
                that.field.pdfAttachments.sort(function compare(a, b) {
                    var before = __WEBPACK_IMPORTED_MODULE_6_moment__(a['dateUpdated']).isBefore(__WEBPACK_IMPORTED_MODULE_6_moment__(b['dateUpdated']));
    ...
    PDFListComponent.prototype.getDownloadUrl = function (attachment, generateFileName, index) {
        if (generateFileName === void 0) { generateFileName = false; }
    ...
    PDFListComponent.prototype.showDialog = function () {
        var diagSel = "." + this.field.name + "PdfDialog";
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return PublishDataLocationRefreshField; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PublishDataLocationRefreshComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__field_simple_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-simple.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__field_base__ = __webpack_require__("./redbox-portal/angular/shared/form/field-base.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__records_service__ = __webpack_require__("./redbox-portal/angular/shared/form/records.service.ts");
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return RecordPermissionsField; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RecordPermissionsComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__field_simple_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-simple.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__field_base__ = __webpack_require__("./redbox-portal/angular/shared/form/field-base.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_observable_zip__ = __webpack_require__("./node_modules/rxjs/_esm5/add/observable/zip.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_observable_fromPromise__ = __webpack_require__("./node_modules/rxjs/_esm5/observable/fromPromise.js");
    ...
    */
    RecordPermissionsField.prototype.asyncLoadData = function () {
        ...
        if (oid == null || oid == "") {
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_7_rxjs_observable_fromPromise__["a" /* fromPromise */])(this.recordsService.getPermissions(oid)).flatMap(function (permissions) {
                that.permissions = permissions;
                return __WEBPACK_IMPORTED_MODULE_5_rxjs_Observable__["a" /* Observable */].of(permissions);
            });
        }
    };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return RelatedFileUploadField; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RelatedFileUploadComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__field_simple_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-simple.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__field_base__ = __webpack_require__("./redbox-portal/angular/shared/form/field-base.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash__ = __webpack_require__("./node_modules/lodash/lodash.js");
...
var RelatedFileUploadField = /** @class */ (function (_super) {
    ...
    function RelatedFileUploadField(options, injector) {
        ...
        _this.accessDeniedObjects = [];
        _this.locationHeader = _this.getTranslated(options['locationHeader'], 'Location');
        _this.notesEnabled = !__WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](options['notesEnabled']) ? options['notesEnabled'] : true;
...
var RelatedObjectDataField = /** @class */ (function (_super) {
    ...
    function RelatedObjectDataField(options, injector) {
        ...
        _this.value = options['value'] || _this.setEmptyValue();
        _this.recordsService = _this.getFromInjector(__WEBPACK_IMPORTED_MODULE_5__records_service__["a" /* RecordsService */]);
        _this.ignoreEmptyTitle = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options['ignoreEmptyTitle']) ? false : options['ignoreEmptyTitle'];
        return _this;
    }
    /**
    * Loading the metadata for each related object in the array
    */
    RelatedObjectDataField.prototype.asyncLoadData = function () {
        ...
        var getRecordMetaObs = [];
        var that = this;
        var portalPath = this.recordsService.getBrandingAndPortalUrl;
        __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.value, function (item) {
            getRecordMetaObs.push(Object(__WEBPACK_IMPORTED_MODULE_8_rxjs_observable_fromPromise__["a" /* fromPromise */])(_this.recordsService.getRecordMeta(item.id)).flatMap(function (meta) {
                var customFields = { oid: item.id, portalPath: portalPath };
                // we add a property called 'oid' so the item can be 'linked' in the UI
                if (!meta) {
                    that.failedObjects.push(customFields);
                }
                else {
                    __WEBPACK_IMPORTED_MODULE_4_lodash__["merge"](meta, customFields);
    ...
    RelatedObjectDataField.prototype.getPropertyValue = function (item, columnConf) {
        var val = '';
        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](columnConf.property)) {
            __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](columnConf.property, function (propName) {
                if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isString"](item)) {
                    val = item;
                }
                else {
                    val = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](item, propName);
                    if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](val)) {
                        return false;
                    }
                }
            });
            ...
            val = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](item, columnConf.property);
        }
        return val;
    };
    RelatedObjectDataField.prototype.getPropertyLabel = function (item, columnConf) {
        var val = this.getPropertyValue(item, columnConf);
        return this.getTranslated(val['label'], val['label']);
    };
    RelatedObjectDataField.prototype.isMultiValue = function (item, columnConf) {
        return __WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](this.getPropertyValue(item, columnConf));
    };
    RelatedObjectDataField.prototype.getContext = function (item, columConf) {
...
var RelatedObjectDataComponent = /** @class */ (function (_super) {
    ...
    function RelatedObjectDataComponent(sanitizer) {
        var _this = _super.call(this) || this;
        _this.sanitizer = sanitizer;
        return _this;
    }
    RelatedObjectDataComponent.prototype.sanitizeUrl = function (url) {
        return this.sanitizer.bypassSecurityTrustUrl(url);
    };
    RelatedObjectDataComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_9__angular_platform_browser__["c" /* DomSanitizer */]])
...
var RepeatableContributorComponent = /** @class */ (function (_super) {
    ...
    RepeatableContributorComponent.prototype.addElem = function (event) {
        ...
        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](newElem.vocabField)) {
...
var SelectionFieldComponent = /** @class */ (function (_super) {
    ...
    SelectionFieldComponent.prototype.isValArray = function () {
        return __WEBPACK_IMPORTED_MODULE_3_lodash__["isArray"](this.field.value) || this.field.controlType == 'checkbox';
    };
    ...
    SelectionFieldComponent.prototype.getControlFromOption = function (opt) {
        ...
        var control = __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](fc['controls'], function (ctrl) {
    ...
    SelectionFieldComponent.prototype.getCheckedFromOption = function (opt) {
        ...
        var checked = !__WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](control);
        return checked;
    };
...
var SelectionField = /** @class */ (function (_super) {
    ...
    function SelectionField(options, injector) {
        ...
        _this.valueIsLink = options.valueIsLink ? options.valueIsLink : false;
    ...
    SelectionField.prototype.createFormModel = function () {
        ...
        if (this.controlType == 'checkbox') {
            var fgDef_1 = [];
            __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](this.selectOptions, function (opt) {
            ...
            // return fg;
            if (this.required) {
                this.validators = __WEBPACK_IMPORTED_MODULE_2__angular_forms__["j" /* Validators */].required;
            }
            this.formModel = new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormArray */](fgDef_1, this.validators);
            return this.formModel;
        }
        else {
    ...
    SelectionField.prototype.reactEvent = function (eventName, eventData, origData) {
        var _this = this;
        if (this.controlType == "checkbox") {
            this.setValue(eventData, false);
            __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](this.componentReactors, function (compReact) {
                compReact.reactEvent(eventName, eventData, origData, _this);
            });
        }
        else {
            _super.prototype.reactEvent.call(this, eventName, eventData, origData);
        }
    };
    SelectionField.prototype.setValue = function (value, emitEvent) {
        var _this = this;
        if (emitEvent === void 0) { emitEvent = true; }
        if (this.controlType == "checkbox") {
            if (!__WEBPACK_IMPORTED_MODULE_3_lodash__["isArray"](value) || value.length > this.selectOptions.length) {
                console.error("The value is not an array or the array exceeds the available options.");
                return;
            }
            this.value = value;
            __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](this.value, function (val, idx) {
                if (__WEBPACK_IMPORTED_MODULE_3_lodash__["toNumber"](idx) > _this.formModel.length - 1) {
                    _this.formModel.push(new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormControl */](val));
                }
                else {
                    _this.formModel.controls[__WEBPACK_IMPORTED_MODULE_3_lodash__["toNumber"](idx)].setValue(val);
                }
            });
            if (this.value.length < this.formModel.length) {
                var diff = this.formModel.length - this.value.length;
            ...
            _super.prototype.setValue.call(this, value, emitEvent);
        }
    };
...
var Container = /** @class */ (function (_super) {
    ...
    Container.prototype.getGroup = function (group, fieldMap) {
        this.fieldMap = fieldMap;
        __WEBPACK_IMPORTED_MODULE_3_lodash__["set"](fieldMap, this.getFullFieldName() + ".field", this);
        group[this.name] = this.required ? new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* FormGroup */]({}, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["j" /* Validators */].required) : new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* FormGroup */]({});
    ...
    Container.prototype.createFormModel = function (valueElem) {
        ...
        this.formModel = this.required ? new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* FormGroup */](grp, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["j" /* Validators */].required) : new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* FormGroup */](grp);
        return this.formModel;
    };
    Container.prototype.setValue = function (value, emitEvent) {
        ...
        for (key in value) {
            if (value.hasOwnProperty(key)) {
                var val = value[key];
                var fld = __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](this.fields, function (fldItem) {
...
var DateTime = /** @class */ (function (_super) {
    ...
    function DateTime(options, injector) {
        var _this = _super.call(this, options, injector) || this;
        _this.updatePlaceholderAsFormat(options['datePickerOpts']);
    ...
    DateTime.prototype.updatePlaceholderAsFormat = function (options, fieldName) {
        if (fieldName === void 0) { fieldName = 'placeholderAsFormat'; }
        if (__WEBPACK_IMPORTED_MODULE_3_lodash__["get"](options, fieldName, false) && __WEBPACK_IMPORTED_MODULE_3_lodash__["get"](options, 'format')) {
            __WEBPACK_IMPORTED_MODULE_3_lodash__["set"](options, 'placeholder', __WEBPACK_IMPORTED_MODULE_3_lodash__["get"](options, 'format'));
        }
    };
    ...
    DateTime.prototype.formatValue = function (value) {
        ...
        return value ? __WEBPACK_IMPORTED_MODULE_4_moment__(value).local().format(this.valueFormat) : value;
    };
    DateTime.prototype.parseToDate = function (value) {
        return __WEBPACK_IMPORTED_MODULE_4_moment__(value, this.valueFormat).local().toDate();
    };
    DateTime.prototype.formatValueForDisplay = function () {
        ...
        return this.value ? __WEBPACK_IMPORTED_MODULE_4_moment__(this.value).locale(locale).format(this.displayFormat) : '';
    };
    DateTime.prototype.reactEvent = function (eventName, eventData, origData) {
        if (this.adjustStartRange) {
            var thisDate = __WEBPACK_IMPORTED_MODULE_4_moment__(eventData);
            var prevStartDate = __WEBPACK_IMPORTED_MODULE_4_moment__(this.formModel.value);
...
var SaveButton = /** @class */ (function (_super) {
    ...
    function SaveButton(options, injector) {
        ...
        _this.disableValidation = __WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](options['disableValidation']) ? false : options['disableValidation'];
        _this.clickedValue = options['clickedValue'] || '';
        return _this;
    }
    return SaveButton;
}(__WEBPACK_IMPORTED_MODULE_1__field_base__["a" /* FieldBase */]));
...
var HtmlRaw = /** @class */ (function (_super) {
    ...
    function HtmlRaw(options, injector) {
        var _this = _super.call(this, options, injector) || this;
        _this.template = options['template'];
        if (!__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](_this.template)) {
            var imports = __WEBPACK_IMPORTED_MODULE_3_lodash__["extend"]({ moment: __WEBPACK_IMPORTED_MODULE_4_moment__ }, _this);
            var templateData = { imports: imports };
            var template = __WEBPACK_IMPORTED_MODULE_3_lodash__["template"](_this.template, templateData);
            _this.value = template();
        }
        return _this;
    }
    HtmlRaw.prototype.getGroup = function (group, fieldMap) {
        _super.prototype.getGroup.call(this, group, fieldMap);
        if (__WEBPACK_IMPORTED_MODULE_3_lodash__["isString"](this.value)) {
...
var TextField = /** @class */ (function (_super) {
    ...
    function TextField(options, injector) {
        ...
        _this.maxLength = __WEBPACK_IMPORTED_MODULE_1_lodash__["isUndefined"](options['maxLength']) ? 524288 : options['maxLength'];
        return _this;
    }
...
var VocabField = /** @class */ (function (_super) {
    ...
    function VocabField(options, injector) {
        ...
        _this.placeHolder = _this.translationService.t(_this.placeHolder);
        ...
        _this.unflattenFlag = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options['unflattenFlag']) ? false : options['unflattenFlag'];
        _this.dontEmitEventOnLoad = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options['dontEmitEventOnLoad']) ? false : options['dontEmitEventOnLoad'];
        _this.groupClasses = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options['groupClasses']) ? '' : options['groupClasses'];
        _this.cssClasses = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options['cssClasses']) ? '' : options['cssClasses'];
        return _this;
    }
...
var MintLookupDataService = /** @class */ (function (_super) {
    ...
    MintLookupDataService.prototype.getCompleterDescription = function (data) {
        ...
        if (data) {
            ...
            else if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](fieldDesc)) {
                // enable descriptions to be built as an array
                __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](fieldDesc, function (fDesc) {
                    description = "" + description + (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](description) ? '' : _this.titleFieldDelim) + data[fDesc];
                });
            }
        }
        return description;
...
var VocabFieldComponent = /** @class */ (function (_super) {
    ...
    VocabFieldComponent.prototype.getGroupClass = function (fldName) {
        ...
        if (this.isEmbedded) {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.field.groupClasses)) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return EventHandlerComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__field_simple_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-simple.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__field_simple__ = __webpack_require__("./redbox-portal/angular/shared/form/field-simple.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash__ = __webpack_require__("./node_modules/lodash/lodash.js");
...
var EventHandler = /** @class */ (function (_super) {
    ...
    function EventHandler(options, injector) {
        ...
        _this.eventSource = __WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](options['eventSource']) ? 'window' : options['eventSource'];
        return _this;
    }
    EventHandler.prototype.getGroup = function (group, fieldMap) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](this.options.subscribe)) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        allTypes = _a.sent();
                        return [2 /*return*/, __WEBPACK_IMPORTED_MODULE_6_lodash__["filter"](allTypes, function (recType) { return recType.packageType == packageType; })];
                }
            });
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_numeral__ = __webpack_require__("./node_modules/numeral/numeral.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_numeral___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_numeral__);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var WorkspaceSelectorField = /** @class */ (function (_super) {
    ...
    function WorkspaceSelectorField(options, injector) {
        ...
        _this.displayAsList = __WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](options['displayAsList']) ? false : options['displayAsList'];
        _this.shouldSaveForm = __WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](options['shouldSaveForm']) ? true : options['shouldSaveForm'];
        _this.allowAddTemplate = options['allowAddTemplate'];
        // this.options = options['options'] || [];
        _this.workspaceApps = __WEBPACK_IMPORTED_MODULE_3_lodash__["map"](options['defaultSelection'] || [], function (option) {
            __WEBPACK_IMPORTED_MODULE_3_lodash__["forOwn"](option, function (val, key) {
        ...
        _this.workspaceTypeService.getWorkspaceTypes().then(function (response) {
            if (response['status']) {
                ...
                __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](response['workspaceTypes'], function (wType) {
                    __WEBPACK_IMPORTED_MODULE_3_lodash__["forOwn"](wType, function (val, key) {
                        // all keys will go through the translation file by default
                        wType[key] = _this.getTranslated(val, val);
                    });
                    var existingWtype = __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](_this.workspaceApps, function (w) { return w['name'] == wType['name']; });
                    if (!__WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](existingWtype)) {
                        __WEBPACK_IMPORTED_MODULE_3_lodash__["assign"](existingWtype, wType);
    ...
    WorkspaceSelectorField.prototype.triggerAllowAdd = function (data) {
        if (data === void 0) { data = undefined; }
        if (!__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](this.allowAddTemplate)) {
            var imports = __WEBPACK_IMPORTED_MODULE_3_lodash__["extend"]({ data: data, moment: __WEBPACK_IMPORTED_MODULE_5_moment__, numeral: __WEBPACK_IMPORTED_MODULE_6_numeral__ }, this);
            var templateData = { imports: imports };
            var template = __WEBPACK_IMPORTED_MODULE_3_lodash__["template"](this.allowAddTemplate, templateData);
            var templateRes = template();
            // bake in the RDMP check
            this.allowAdd = !__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](this.rdmp) && templateRes == "true";
        }
        else {
            this.allowAdd = !__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](this.rdmp);
        }
    };
...
var WorkspaceSelectorFieldComponent = /** @class */ (function (_super) {
    ...
    WorkspaceSelectorFieldComponent.prototype.saveAndOpenWorkspace = function (workspaceType) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_2_lodash__["isUndefined"](workspaceType)) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__form_field_recordpermissions_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-recordpermissions.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__form_field_datalocation_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-datalocation.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__form_field_relatedfileupload_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-relatedfileupload.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__form_field_publishdatalocationselector_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-publishdatalocationselector.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__form_field_andsvocab_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-andsvocab.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__form_field_map_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-map.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__form_workflow_button_component__ = __webpack_require__("./redbox-portal/angular/shared/form/workflow-button.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__form_action_button_component__ = __webpack_require__("./redbox-portal/angular/shared/form/action-button.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__config_service__ = __webpack_require__("./redbox-portal/angular/shared/config-service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__translation_service__ = __webpack_require__("./redbox-portal/angular/shared/translation-service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25_ng2_datetime_ng2_datetime__ = __webpack_require__("./node_modules/ng2-datetime/ng2-datetime.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26_ng2_completer__ = __webpack_require__("./node_modules/ng2-completer/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27_ngx_i18next__ = __webpack_require__("./node_modules/ngx-i18next/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27_ngx_i18next___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_27_ngx_i18next__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__asymmetrik_ngx_leaflet__ = __webpack_require__("./node_modules/@asymmetrik/ngx-leaflet/dist/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__asymmetrik_ngx_leaflet_draw__ = __webpack_require__("./node_modules/@asymmetrik/ngx-leaflet-draw/dist/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__form_dmp_field_component__ = __webpack_require__("./redbox-portal/angular/shared/form/dmp-field.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__user_service_simple__ = __webpack_require__("./redbox-portal/angular/shared/user.service-simple.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__dashboard_service__ = __webpack_require__("./redbox-portal/angular/shared/dashboard-service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__ands_service__ = __webpack_require__("./redbox-portal/angular/shared/ands-service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__StringTemplatePipe__ = __webpack_require__("./redbox-portal/angular/shared/StringTemplatePipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__roles_service__ = __webpack_require__("./redbox-portal/angular/shared/roles-service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__util_service__ = __webpack_require__("./redbox-portal/angular/shared/util-service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__email_service__ = __webpack_require__("./redbox-portal/angular/shared/email-service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__form_field_group_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-group.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__form_workspace_selector_component__ = __webpack_require__("./redbox-portal/angular/shared/form/workspace-selector.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__workspace_service__ = __webpack_require__("./redbox-portal/angular/shared/workspace-service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__form_workspace_field_component__ = __webpack_require__("./redbox-portal/angular/shared/form/workspace-field.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__form_field_control_meta_service__ = __webpack_require__("./redbox-portal/angular/shared/form/field-control-meta.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43_angular_tree_component__ = __webpack_require__("./node_modules/angular-tree-component/dist/angular-tree-component.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__form_field_asynch_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-asynch.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__form_tree_node_checkbox_component__ = __webpack_require__("./redbox-portal/angular/shared/form/tree-node-checkbox.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__form_field_publish_data_location_refresh_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-publish-data-location-refresh.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47_mobx_angular__ = __webpack_require__("./node_modules/mobx-angular/dist/mobx-angular.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__form_html_event_component__ = __webpack_require__("./redbox-portal/angular/shared/form/html-event.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SharedModule = /** @class */ (function () {
    ...
    SharedModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["d" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["i" /* ReactiveFormsModule */], __WEBPACK_IMPORTED_MODULE_25_ng2_datetime_ng2_datetime__["a" /* NKDatetimeModule */], __WEBPACK_IMPORTED_MODULE_26_ng2_completer__["b" /* Ng2CompleterModule */], __WEBPACK_IMPORTED_MODULE_27_ngx_i18next__["TranslateI18NextModule"], __WEBPACK_IMPORTED_MODULE_28__asymmetrik_ngx_leaflet__["c" /* LeafletModule */].forRoot(), __WEBPACK_IMPORTED_MODULE_29__asymmetrik_ngx_leaflet_draw__["a" /* LeafletDrawModule */].forRoot(), __WEBPACK_IMPORTED_MODULE_1_angular2_markdown__["a" /* MarkdownModule */].forRoot(), __WEBPACK_IMPORTED_MODULE_43_angular_tree_component__["b" /* TreeModule */], __WEBPACK_IMPORTED_MODULE_47_mobx_angular__["a" /* MobxAngularModule */]],
            exports: [__WEBPACK_IMPORTED_MODULE_25_ng2_datetime_ng2_datetime__["a" /* NKDatetimeModule */], __WEBPACK_IMPORTED_MODULE_26_ng2_completer__["b" /* Ng2CompleterModule */], __WEBPACK_IMPORTED_MODULE_27_ngx_i18next__["TranslateI18NextModule"], __WEBPACK_IMPORTED_MODULE_30__form_dmp_field_component__["a" /* DmpFieldComponent */], __WEBPACK_IMPORTED_MODULE_6__form_field_textfield_component__["g" /* TextFieldComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["e" /* DropdownFieldComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["o" /* TabOrAccordionContainerComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["b" /* ButtonBarContainerComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["p" /* TextBlockComponent */], __WEBPACK_IMPORTED_MODULE_6__form_field_textfield_component__["b" /* MarkdownTextAreaComponent */], __WEBPACK_IMPORTED_MODULE_6__form_field_textfield_component__["e" /* TextAreaComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["d" /* DateTimeComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["a" /* AnchorOrButtonComponent */], __WEBPACK_IMPORTED_MODULE_9__form_field_vocab_component__["b" /* VocabFieldComponent */], __WEBPACK_IMPORTED_MODULE_10__form_field_repeatable_component__["g" /* RepeatableVocabComponent */], __WEBPACK_IMPORTED_MODULE_11__form_field_contributor_component__["a" /* ContributorComponent */], __WEBPACK_IMPORTED_MODULE_10__form_field_repeatable_component__["e" /* RepeatableContributorComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["g" /* HtmlRawComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["f" /* HiddenValueComponent */], __WEBPACK_IMPORTED_MODULE_21__form_workflow_button_component__["b" /* WorkflowStepButtonComponent */], __WEBPACK_IMPORTED_MODULE_22__form_action_button_component__["b" /* ActionButtonComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["h" /* LinkValueComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["k" /* SelectionFieldComponent */], __WEBPACK_IMPORTED_MODULE_6__form_field_textfield_component__["c" /* RepeatableTextfieldComponent */], __WEBPACK_IMPORTED_MODULE_34__StringTemplatePipe__["a" /* StringTemplatePipe */], __WEBPACK_IMPORTED_MODULE_38__form_field_group_component__["a" /* GenericGroupComponent */], __WEBPACK_IMPORTED_MODULE_38__form_field_group_component__["b" /* RepeatableGroupComponent */], __WEBPACK_IMPORTED_MODULE_20__form_field_map_component__["a" /* MapComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["i" /* ParameterRetrieverComponent */], __WEBPACK_IMPORTED_MODULE_8__form_record_meta_component__["a" /* RecordMetadataRetrieverComponent */], __WEBPACK_IMPORTED_MODULE_14__form_field_relatedobjectselector_component__["a" /* RelatedObjectSelectorComponent */], __WEBPACK_IMPORTED_MODULE_16__form_field_datalocation_component__["a" /* DataLocationComponent */], __WEBPACK_IMPORTED_MODULE_17__form_field_relatedfileupload_component__["a" /* RelatedFileUploadComponent */], __WEBPACK_IMPORTED_MODULE_18__form_field_publishdatalocationselector_component__["a" /* PublishDataLocationSelectorComponent */], __WEBPACK_IMPORTED_MODULE_39__form_workspace_selector_component__["b" /* WorkspaceSelectorFieldComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["n" /* TabNavButtonComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["m" /* SpacerComponent */], __WEBPACK_IMPORTED_MODULE_41__form_workspace_field_component__["a" /* WorkspaceFieldComponent */], __WEBPACK_IMPORTED_MODULE_39__form_workspace_selector_component__["a" /* WorkspaceSelectorComponent */], __WEBPACK_IMPORTED_MODULE_19__form_field_andsvocab_component__["a" /* ANDSVocabComponent */], __WEBPACK_IMPORTED_MODULE_12__form_field_pdflist_component__["a" /* PDFListComponent */], __WEBPACK_IMPORTED_MODULE_43_angular_tree_component__["b" /* TreeModule */], __WEBPACK_IMPORTED_MODULE_44__form_field_asynch_component__["a" /* AsynchComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["q" /* ToggleComponent */], __WEBPACK_IMPORTED_MODULE_45__form_tree_node_checkbox_component__["a" /* TreeNodeCheckboxComponent */], __WEBPACK_IMPORTED_MODULE_46__form_field_publish_data_location_refresh_component__["a" /* PublishDataLocationRefreshComponent */], __WEBPACK_IMPORTED_MODULE_48__form_html_event_component__["b" /* EventHandlerComponent */]],
            declarations: [__WEBPACK_IMPORTED_MODULE_30__form_dmp_field_component__["a" /* DmpFieldComponent */], __WEBPACK_IMPORTED_MODULE_6__form_field_textfield_component__["g" /* TextFieldComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["e" /* DropdownFieldComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["o" /* TabOrAccordionContainerComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["b" /* ButtonBarContainerComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["p" /* TextBlockComponent */], __WEBPACK_IMPORTED_MODULE_6__form_field_textfield_component__["b" /* MarkdownTextAreaComponent */], __WEBPACK_IMPORTED_MODULE_6__form_field_textfield_component__["e" /* TextAreaComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["d" /* DateTimeComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["a" /* AnchorOrButtonComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["j" /* SaveButtonComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["c" /* CancelButtonComponent */], __WEBPACK_IMPORTED_MODULE_9__form_field_vocab_component__["b" /* VocabFieldComponent */], __WEBPACK_IMPORTED_MODULE_10__form_field_repeatable_component__["g" /* RepeatableVocabComponent */], __WEBPACK_IMPORTED_MODULE_11__form_field_contributor_component__["a" /* ContributorComponent */], __WEBPACK_IMPORTED_MODULE_10__form_field_repeatable_component__["e" /* RepeatableContributorComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["g" /* HtmlRawComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["f" /* HiddenValueComponent */], __WEBPACK_IMPORTED_MODULE_21__form_workflow_button_component__["b" /* WorkflowStepButtonComponent */], __WEBPACK_IMPORTED_MODULE_22__form_action_button_component__["b" /* ActionButtonComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["h" /* LinkValueComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["k" /* SelectionFieldComponent */], __WEBPACK_IMPORTED_MODULE_6__form_field_textfield_component__["c" /* RepeatableTextfieldComponent */], __WEBPACK_IMPORTED_MODULE_13__form_field_relatedobjectdata_component__["a" /* RelatedObjectDataComponent */], __WEBPACK_IMPORTED_MODULE_34__StringTemplatePipe__["a" /* StringTemplatePipe */], __WEBPACK_IMPORTED_MODULE_38__form_field_group_component__["a" /* GenericGroupComponent */], __WEBPACK_IMPORTED_MODULE_38__form_field_group_component__["b" /* RepeatableGroupComponent */], __WEBPACK_IMPORTED_MODULE_20__form_field_map_component__["a" /* MapComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["i" /* ParameterRetrieverComponent */], __WEBPACK_IMPORTED_MODULE_8__form_record_meta_component__["a" /* RecordMetadataRetrieverComponent */], __WEBPACK_IMPORTED_MODULE_14__form_field_relatedobjectselector_component__["a" /* RelatedObjectSelectorComponent */], __WEBPACK_IMPORTED_MODULE_16__form_field_datalocation_component__["a" /* DataLocationComponent */], __WEBPACK_IMPORTED_MODULE_17__form_field_relatedfileupload_component__["a" /* RelatedFileUploadComponent */], __WEBPACK_IMPORTED_MODULE_18__form_field_publishdatalocationselector_component__["a" /* PublishDataLocationSelectorComponent */], __WEBPACK_IMPORTED_MODULE_39__form_workspace_selector_component__["b" /* WorkspaceSelectorFieldComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["n" /* TabNavButtonComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["m" /* SpacerComponent */], __WEBPACK_IMPORTED_MODULE_41__form_workspace_field_component__["a" /* WorkspaceFieldComponent */], __WEBPACK_IMPORTED_MODULE_39__form_workspace_selector_component__["a" /* WorkspaceSelectorComponent */], __WEBPACK_IMPORTED_MODULE_19__form_field_andsvocab_component__["a" /* ANDSVocabComponent */], __WEBPACK_IMPORTED_MODULE_12__form_field_pdflist_component__["a" /* PDFListComponent */], __WEBPACK_IMPORTED_MODULE_44__form_field_asynch_component__["a" /* AsynchComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["q" /* ToggleComponent */], __WEBPACK_IMPORTED_MODULE_45__form_tree_node_checkbox_component__["a" /* TreeNodeCheckboxComponent */], __WEBPACK_IMPORTED_MODULE_46__form_field_publish_data_location_refresh_component__["a" /* PublishDataLocationRefreshComponent */], __WEBPACK_IMPORTED_MODULE_15__form_field_recordpermissions_component__["a" /* RecordPermissionsComponent */], __WEBPACK_IMPORTED_MODULE_48__form_html_event_component__["b" /* EventHandlerComponent */]],
            providers: [__WEBPACK_IMPORTED_MODULE_5__form_field_control_service__["a" /* FieldControlService */], __WEBPACK_IMPORTED_MODULE_4__form_records_service__["a" /* RecordsService */], __WEBPACK_IMPORTED_MODULE_9__form_field_vocab_component__["c" /* VocabFieldLookupService */], __WEBPACK_IMPORTED_MODULE_23__config_service__["a" /* ConfigService */], __WEBPACK_IMPORTED_MODULE_24__translation_service__["a" /* TranslationService */], __WEBPACK_IMPORTED_MODULE_31__user_service_simple__["a" /* UserSimpleService */], __WEBPACK_IMPORTED_MODULE_32__dashboard_service__["a" /* DashboardService */], __WEBPACK_IMPORTED_MODULE_35__roles_service__["a" /* RolesService */], __WEBPACK_IMPORTED_MODULE_37__email_service__["a" /* EmailNotificationService */], __WEBPACK_IMPORTED_MODULE_36__util_service__["a" /* UtilityService */], __WEBPACK_IMPORTED_MODULE_40__workspace_service__["a" /* WorkspaceTypeService */], __WEBPACK_IMPORTED_MODULE_42__form_field_control_meta_service__["a" /* FieldControlMetaService */], __WEBPACK_IMPORTED_MODULE_33__ands_service__["a" /* ANDSService */]],
            bootstrap: [],
            entryComponents: [__WEBPACK_IMPORTED_MODULE_30__form_dmp_field_component__["a" /* DmpFieldComponent */], __WEBPACK_IMPORTED_MODULE_6__form_field_textfield_component__["g" /* TextFieldComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["e" /* DropdownFieldComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["o" /* TabOrAccordionContainerComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["b" /* ButtonBarContainerComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["p" /* TextBlockComponent */], __WEBPACK_IMPORTED_MODULE_6__form_field_textfield_component__["b" /* MarkdownTextAreaComponent */], __WEBPACK_IMPORTED_MODULE_6__form_field_textfield_component__["e" /* TextAreaComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["d" /* DateTimeComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["a" /* AnchorOrButtonComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["j" /* SaveButtonComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["c" /* CancelButtonComponent */], __WEBPACK_IMPORTED_MODULE_9__form_field_vocab_component__["b" /* VocabFieldComponent */], __WEBPACK_IMPORTED_MODULE_10__form_field_repeatable_component__["g" /* RepeatableVocabComponent */], __WEBPACK_IMPORTED_MODULE_11__form_field_contributor_component__["a" /* ContributorComponent */], __WEBPACK_IMPORTED_MODULE_10__form_field_repeatable_component__["e" /* RepeatableContributorComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["g" /* HtmlRawComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["f" /* HiddenValueComponent */], __WEBPACK_IMPORTED_MODULE_21__form_workflow_button_component__["b" /* WorkflowStepButtonComponent */], __WEBPACK_IMPORTED_MODULE_22__form_action_button_component__["b" /* ActionButtonComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["h" /* LinkValueComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["k" /* SelectionFieldComponent */], __WEBPACK_IMPORTED_MODULE_6__form_field_textfield_component__["c" /* RepeatableTextfieldComponent */], __WEBPACK_IMPORTED_MODULE_13__form_field_relatedobjectdata_component__["a" /* RelatedObjectDataComponent */], __WEBPACK_IMPORTED_MODULE_38__form_field_group_component__["a" /* GenericGroupComponent */], __WEBPACK_IMPORTED_MODULE_38__form_field_group_component__["b" /* RepeatableGroupComponent */], __WEBPACK_IMPORTED_MODULE_20__form_field_map_component__["a" /* MapComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["i" /* ParameterRetrieverComponent */], __WEBPACK_IMPORTED_MODULE_8__form_record_meta_component__["a" /* RecordMetadataRetrieverComponent */], __WEBPACK_IMPORTED_MODULE_14__form_field_relatedobjectselector_component__["a" /* RelatedObjectSelectorComponent */], __WEBPACK_IMPORTED_MODULE_16__form_field_datalocation_component__["a" /* DataLocationComponent */], __WEBPACK_IMPORTED_MODULE_17__form_field_relatedfileupload_component__["a" /* RelatedFileUploadComponent */], __WEBPACK_IMPORTED_MODULE_18__form_field_publishdatalocationselector_component__["a" /* PublishDataLocationSelectorComponent */], __WEBPACK_IMPORTED_MODULE_39__form_workspace_selector_component__["b" /* WorkspaceSelectorFieldComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["n" /* TabNavButtonComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["m" /* SpacerComponent */], __WEBPACK_IMPORTED_MODULE_41__form_workspace_field_component__["a" /* WorkspaceFieldComponent */], __WEBPACK_IMPORTED_MODULE_39__form_workspace_selector_component__["a" /* WorkspaceSelectorComponent */], __WEBPACK_IMPORTED_MODULE_19__form_field_andsvocab_component__["a" /* ANDSVocabComponent */], __WEBPACK_IMPORTED_MODULE_12__form_field_pdflist_component__["a" /* PDFListComponent */], __WEBPACK_IMPORTED_MODULE_44__form_field_asynch_component__["a" /* AsynchComponent */], __WEBPACK_IMPORTED_MODULE_7__form_field_simple_component__["q" /* ToggleComponent */], __WEBPACK_IMPORTED_MODULE_45__form_tree_node_checkbox_component__["a" /* TreeNodeCheckboxComponent */], __WEBPACK_IMPORTED_MODULE_46__form_field_publish_data_location_refresh_component__["a" /* PublishDataLocationRefreshComponent */], __WEBPACK_IMPORTED_MODULE_15__form_field_recordpermissions_component__["a" /* RecordPermissionsComponent */], __WEBPACK_IMPORTED_MODULE_48__form_html_event_component__["b" /* EventHandlerComponent */]]
        })
    ], SharedModule);
    return SharedModule;
}());
...
var UtilityService = /** @class */ (function () {
    ...
    UtilityService.prototype.convertToDateFormat = function (data, config) {
        ...
        var converted = __WEBPACK_IMPORTED_MODULE_2_moment__(value, formatOrigin).format(formatTarget);
    ...
    UtilityService.prototype.runTemplate = function (data, config) {
        var imports = __WEBPACK_IMPORTED_MODULE_1_lodash__["extend"]({ data: data, config: config, moment: __WEBPACK_IMPORTED_MODULE_2_moment__, numeral: __WEBPACK_IMPORTED_MODULE_3_numeral__ }, this);
        var templateData = { imports: imports };
        ...
        if (config.json == true && !__WEBPACK_IMPORTED_MODULE_1_lodash__["isEmpty"](templateRes)) {
...
/***/ "./src/app/describo.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DescriboFrameComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__ = __webpack_require__("./node_modules/@angular/platform-browser/esm5/platform-browser.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_user_service_simple__ = __webpack_require__("./redbox-portal/angular/shared/user.service-simple.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_dashboard_service__ = __webpack_require__("./redbox-portal/angular/shared/dashboard-service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash__ = __webpack_require__("./node_modules/lodash/lodash.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_loadable_component__ = __webpack_require__("./redbox-portal/angular/shared/loadable.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_form_records_service__ = __webpack_require__("./redbox-portal/angular/shared/form/records.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_workspace_service__ = __webpack_require__("./redbox-portal/angular/shared/workspace-service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__describo_service__ = __webpack_require__("./src/app/describo.service.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var DescriboFrameComponent = /** @class */ (function (_super) {
    __extends(DescriboFrameComponent, _super);
    function DescriboFrameComponent(workspaceTypeService, dashboardService, recordsService, document, elementRef, translationService, app, UserSimpleService, DescriboService, sanitizer) {
        var _this = _super.call(this) || this;
        _this.workspaceTypeService = workspaceTypeService;
        ...
        _this.translationService = translationService;
        _this.app = app;
        _this.UserSimpleService = UserSimpleService;
        _this.DescriboService = DescriboService;
        _this.sanitizer = sanitizer;
        _this.workflowSteps = [];
        _this.saveMsgType = "info";
        _this.services = [];
        _this.rdmpUrl = '';
        _this.requestButtonLabel = 'Next';
        _this.iFrameURL = null;
        _this.errorMessage = '';
        _this.setLoading(true);
        _this.initTranslator(_this.translationService);
        return _this;
    }
    DescriboFrameComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.initSubs = this.dashboardService.waitForInit(function (initStat) {
            _this.initSubs.unsubscribe();
            _this.translationService.isReady(function (tService) {
                _this.typeColLabel = _this.getTranslated("workspaces-type-column", "Type");
                _this.descriptionColLabel = _this.getTranslated("workspaces-description-column", "Description");
                _this.recordColLabel = _this.getTranslated("workspaces-title-column", "Name");
                _this.linkColLlabel = _this.getTranslated("workspaces-link-column", "Location");
                _this.rdmpColLabel = _this.getTranslated("workspaces-rdmp-column", "Plan");
                _this.searchLabel = _this.getTranslated('create-workspace-selector-search', 'Search for your Data Management Plan');
                _this.createWorkspaceLabel = _this.getTranslated('create-workspace', "Find a plan to create a research workspace");
                _this.nextButtonLabel = _this.getTranslated('create-workspace-next', "Next");
                _this.backButtonLabel = _this.getTranslated('create-workspace-back', "Back");
            });
            _this.UserSimpleService.getInfo().then(function (userInfo) {
                _this.user = __WEBPACK_IMPORTED_MODULE_4_lodash__["clone"](userInfo);
                _this.loadFrame();
                _this.checkIfHasLoaded();
            });
        });
    };
    DescriboFrameComponent.prototype.hasLoaded = function () {
        return this.translatorReady && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.records);
    };
    DescriboFrameComponent.prototype.getTranslated = function (key, defValue) {
        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](key) && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](key)) {
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isFunction"](key.startsWith)) {
                var translatedValue = this.translationService.t(key);
    ...
    DescriboFrameComponent.prototype.loadFrame = function () {
        var _this = this;
        this.DescriboService.getSessionId(this.user).then(function (res) {
            if (res.status) {
                _this.iFrameURL = _this.sanitizer.bypassSecurityTrustResourceUrl(res.url);
            }
            else {
    ...
    DescriboFrameComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            moduleId: module.i,
            selector: 'describo',
            template: __webpack_require__("./src/app/describo.html")
        }),
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __param(0, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_8__shared_workspace_service__["a" /* WorkspaceTypeService */])),
        __param(1, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_3__shared_dashboard_service__["a" /* DashboardService */])),
        ...
        __param(7, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_2__shared_user_service_simple__["a" /* UserSimpleService */])),
        __param(8, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_9__describo_service__["a" /* DescriboService */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_8__shared_workspace_service__["a" /* WorkspaceTypeService */],
            __WEBPACK_IMPORTED_MODULE_3__shared_dashboard_service__["a" /* DashboardService */],
            __WEBPACK_IMPORTED_MODULE_7__shared_form_records_service__["a" /* RecordsService */], Object, __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"],
            __WEBPACK_IMPORTED_MODULE_6__shared_translation_service__["a" /* TranslationService */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["ApplicationRef"],
            __WEBPACK_IMPORTED_MODULE_2__shared_user_service_simple__["a" /* UserSimpleService */],
            __WEBPACK_IMPORTED_MODULE_9__describo_service__["a" /* DescriboService */],
            __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["c" /* DomSanitizer */]])
    ], DescriboFrameComponent);
    return DescriboFrameComponent;
}(__WEBPACK_IMPORTED_MODULE_5__shared_loadable_component__["a" /* LoadableComponent */]));



/***/ }),

/***/ "./src/app/describo.html":
/***/ (function(module, exports) {

module.exports = "<div *ngIf=\"!isLoading\">\n  <h3 *ngIf=\"!iFrameURL\">{{ errorMessage }}</h3>\n  <iframe *ngIf=\"iFrameURL\" [src]=\"iFrameURL\" title=\"Describo\" height=\"100%\" width=\"100%\" frameborder=\"0\"\n          style=\"display: block;background: #edf2f7;border: none;height: 100vh;\"></iframe>\n</div>\n"

/***/ }),

/***/ "./src/app/describo.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DescriboModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__ = __webpack_require__("./node_modules/@angular/platform-browser/esm5/platform-browser.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_http__ = __webpack_require__("./node_modules/@angular/http/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_workspace_service__ = __webpack_require__("./redbox-portal/angular/shared/workspace-service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__describo_component__ = __webpack_require__("./src/app/describo.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__describo_service__ = __webpack_require__("./src/app/describo.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shared_user_service_simple__ = __webpack_require__("./redbox-portal/angular/shared/user.service-simple.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * @return {[type]}
 */
var DescriboModule = /** @class */ (function () {
    function DescriboModule() {
    }
    DescriboModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["c" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["i" /* ReactiveFormsModule */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["d" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_5_ngx_bootstrap__["a" /* PaginationModule */].forRoot(), __WEBPACK_IMPORTED_MODULE_5_ngx_bootstrap__["b" /* TooltipModule */].forRoot(), __WEBPACK_IMPORTED_MODULE_6__shared_shared_module__["a" /* SharedModule */]],
            declarations: [__WEBPACK_IMPORTED_MODULE_7__describo_component__["a" /* DescriboFrameComponent */]],
            providers: [__WEBPACK_IMPORTED_MODULE_4__shared_workspace_service__["a" /* WorkspaceTypeService */], __WEBPACK_IMPORTED_MODULE_8__describo_service__["a" /* DescriboService */], __WEBPACK_IMPORTED_MODULE_9__shared_user_service_simple__["a" /* UserSimpleService */]],
            bootstrap: [__WEBPACK_IMPORTED_MODULE_7__describo_component__["a" /* DescriboFrameComponent */]],
            entryComponents: []
        })
    ], DescriboModule);
    return DescriboModule;
}());
...
/***/ "./src/app/describo.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DescriboService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__("./node_modules/@angular/http/esm5/http.js");
...
var DescriboService = /** @class */ (function (_super) {
    __extends(DescriboService, _super);
    function DescriboService(http, configService) {
        var _this = _super.call(this, http, configService) || this;
        _this.configService = configService;
        return _this;
    }
    DescriboService.prototype.getSessionId = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var describoUser, wsUrl, result, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        describoUser = {
                        ...
                        wsUrl = this.brandingAndPortalUrl + '/describo/session';
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
    ...
    DescriboService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __param(0, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */])), __param(1, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_5__shared_config_service__["a" /* ConfigService */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */], __WEBPACK_IMPORTED_MODULE_5__shared_config_service__["a" /* ConfigService */]])
    ], DescriboService);
    return DescriboService;
}(__WEBPACK_IMPORTED_MODULE_4__shared_base_service__["a" /* BaseService */]));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_describo_module__ = __webpack_require__("./src/app/describo.module.ts");
...
Object(__WEBPACK_IMPORTED_MODULE_1__angular_platform_browser_dynamic__["a" /* platformBrowserDynamic */])().bootstrapModule(__WEBPACK_IMPORTED_MODULE_2__app_describo_module__["a" /* DescriboModule */]);
